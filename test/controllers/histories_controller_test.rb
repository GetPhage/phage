...
class HistoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create history" do
    assert_difference('History.count') do
      post histories_url, params: { history: { message: @history.message, scan_diff_id: @history.scan_diff_id } }
    end
  ...
  test "should update history" do
    patch history_url(@history), params: { history: { message: @history.message, scan_diff_id: @history.scan_diff_id } }
