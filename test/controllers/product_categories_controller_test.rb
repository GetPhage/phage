...
class ProductCategoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create product_category" do
    assert_difference('ProductCategory.count') do
      post product_categories_url, params: { product_category: { mobile: @product_category.mobile, name: @product_category.name, product_category_id: @product_category.product_category_id } }
    end
  ...
  test "should update product_category" do
    patch product_category_url(@product_category), params: { product_category: { mobile: @product_category.mobile, name: @product_category.name, product_category_id: @product_category.product_category_id } }
