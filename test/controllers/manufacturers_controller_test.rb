...
class ManufacturersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create manufacturer" do
    assert_difference('Manufacturer.count') do
      post manufacturers_url, params: { manufacturer: { name: @manufacturer.name, support_url: @manufacturer.support_url, web: @manufacturer.web } }
    end
  ...
  test "should update manufacturer" do
    patch manufacturer_url(@manufacturer), params: { manufacturer: { name: @manufacturer.name, support_url: @manufacturer.support_url, web: @manufacturer.web } }
