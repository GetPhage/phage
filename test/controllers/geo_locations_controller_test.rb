...
class GeoLocationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create geo_location" do
    assert_difference('GeoLocation.count') do
      post geo_locations_url, params: { geo_location: { continent: @geo_location.continent, country: @geo_location.country, geoname_id: @geo_location.geoname_id } }
    end
  ...
  test "should update geo_location" do
    patch geo_location_url(@geo_location), params: { geo_location: { continent: @geo_location.continent, country: @geo_location.country, geoname_id: @geo_location.geoname_id } }
