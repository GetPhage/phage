...
class ScansControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create scan" do
    assert_difference('Scan.count') do
      post scans_url, params: { scan: { end: @scan.end, notes: @scan.notes, scan_type: @scan.scan_type, start: @scan.start } }
    end
  ...
  test "should update scan" do
    patch scan_url(@scan), params: { scan: { end: @scan.end, notes: @scan.notes, scan_type: @scan.scan_type, start: @scan.start } }
