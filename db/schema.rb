...
ActiveRecord::Schema.define(version: 20171029041709) do
  ...
  create_table "flows", id: :serial, force: :cascade do |t|
    ...
    t.index ["state", "device_id"], name: "index_flows_on_state_and_device_id"
  ...
  create_table "partial_flows", id: :serial, force: :cascade do |t|
    ...
    t.index ["is_syn", "src_ack", "state"], name: "index_partial_flows_on_is_syn_and_src_ack_and_state"
    ...
    t.index ["state"], name: "index_partial_flows_on_state"
  end
